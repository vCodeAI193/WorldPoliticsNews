      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <nav className="flex gap-6 text-sm text-gray-500">
            ...
            <Link href="/nutzungsbedingungen" className="hover:text-gray-900">Nutzungsbedingungen</Link>
            <a href="mailto:kontakt@worldpoliticsnews.de" className="hover:text-gray-900">Kontakt</a>
          </nav>
