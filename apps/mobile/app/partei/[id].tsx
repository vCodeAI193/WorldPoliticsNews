  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 32 }}>
      <View style={styles.headerCard}>
        <Text style={styles.entityType}>🏛️ Partei</Text>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Analysierte Artikel ({analysis.articles.length})</Text>
...
const styles = StyleSheet.create({
  ...
  headerCard: { backgroundColor: '#1a56db', padding: 20, paddingTop: 24 },
